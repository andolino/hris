                  ...
                  <div class="col-9">
                    <div class="btn-group btn-group-toggle mb-3" data-toggle="buttons">
                      <label class="btn btn-secondary active rounded-0">
                        <input type="radio" name="dtr-miss-options" value="in" id="option1" checked> Missed In
                      </label>
                      <label class="btn btn-secondary rounded-0">
                        <input type="radio" name="dtr-miss-options" value="out" id="option2"> Missed Out
                      </label>
                    </div>
                    <table id="tbl-missed-in-out" class="display nowrap table table-striped table-bordered table-sm" data-csrf="{{ csrf_token() }}" width="100%">
                        <thead>
                            <tr>
                                <th class="">
...
{{-- @include('dashboard.modal.dtr_mod') --}}
@endsection
