        ...
        <div class="card">
            <div class="card-header bg-dark">
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <button type="button" class="btn btn-secondary" title="Add Department" data-form="mod_dtr_adj_form" data-type="dtr-adj-request-form" id="show_form"><i class="fa-solid fa-plus"></i></button>
            ...
            <div class="card-body">
                <div class="row">
                  <div class="col-9">
                    <table id="tbl-dtr-adjustment-request" class="display nowrap table table-striped table-bordered table-sm" data-csrf="{{ csrf_token() }}" width="100%">
                        <thead>
                            <tr>
                                <th class="">
...
@include('dashboard.modal.dtr_adj_request_mod')
@endsection
