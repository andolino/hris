        ...
        <div class="card">
            <div class="card-header bg-dark">
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <button type="button" class="btn btn-secondary" title="Add Department" 
                        data-form="mod_dep_form" 
                        data-type="department-sched-form" 
                        id="show_form"><i class="fa-solid fa-plus"></i></button>
            ...
            <div class="card-body">
                <div class="row">
                  <div class="col-7">
                    <table id="tbl-department-schedule" class="display nowrap table table-striped table-bordered table-sm" data-csrf="{{ csrf_token() }}" width="100%">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                          {{-- @forelse ($department_schedule as $item)
                                <tr>
...
@include('dashboard.modal.department')
@endsection
