        ...
        <div class="card">
            <div class="card-header bg-dark">
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <button type="button" class="btn btn-secondary" title="Add Department" data-form="mod_dep_form" data-type="department-form" id="show_form"><i class="fa-solid fa-plus"></i></button>
