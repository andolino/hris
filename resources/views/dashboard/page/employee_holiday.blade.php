        ...
        <div class="card">
            <div class="card-header bg-dark">
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <button type="button" class="btn btn-secondary" title="Add Department" data-form="mod_employee_holiday_form" data-type="employee-holiday-form" id="show_form"><i class="fa-solid fa-plus"></i></button>
            ...
            <div class="card-body">
                <div class="row">
                  <div class="col-6">
                    <table id="tbl-employee-holiday" class="display nowrap table table-striped table-bordered table-sm" data-csrf="{{ csrf_token() }}" width="100%">
                        <thead>
                            <tr>
                                <th class="">
...
@include('dashboard.modal.employee_holiday_mod')
@endsection
